// src/modules/habit/hooks/useHabitCalendar.ts
import { useMemo, useState, useCallback } from 'react';
import { Habit, HABITS } from '../models';
import { useHabitDataDaily } from './useHabitDataDaily.supabase';
import { getLocalDateString } from '@/shared/utils/dates';
import { timeToPixels } from '@/shared/utils/dates';
import {
  parseGoalDuration,
  calculateHabitHeight,
  parseTimeToDate,
} from '@/modules/habit/utils/calendarUtils';
...
export interface HabitWithCalendarData extends Habit {
  ...
  isCompleted: boolean; // Estado de completación desde Supabase
}
 ...
 * - Integra con Supabase para estado de completación
 */
export const useHabitCalendar = (date: Date): UseHabitCalendarReturn => {
  ...
  // Toggle completación (wrapper para toggleHabit de Supabase)
