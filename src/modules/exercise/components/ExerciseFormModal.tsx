// src/modules/exercise/components/ExerciseFormModal.tsx
...
import { ExerciseLog, EXERCISE_CATEGORIES } from '../models';
import { useExerciseTypes, ExerciseType } from '../controllers/useExerciseTypes';
import {
  Tabs,
  TabsContent,
  TabsList,
